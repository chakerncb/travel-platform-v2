		...
		<>
			...
			<section className="box-section block-banner-9 box-banner-home5-search background-body">
				<div className="block-banner-9-inner">
					...
					<div className="image-banner-bottom"> <img src="/assets/imgs/page/homepage9/banner-sm.png" alt="TOURZ" />
					</div>
					<div className="image-banner-top-left"> <img src="/assets/imgs/page/homepage9/banner-sm2.png" alt="TOURZ" />
					</div>
					<div className="block-right-banner" style={{ backgroundImage: 'url(assets/imgs/page/homepage9/banner.png)' }}>
						<div className="item-support border-1 background-body"> <img className="light-mode" src="/assets/imgs/page/homepage9/support.png" alt="TOURZ" /><img className="dark-mode" src="/assets/imgs/page/homepage9/support-dark.png" alt="TOURZ" />
