                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-sm-12">
                            <div className="mb-20"><Link className="d-inline-block mb-20" href="/"><img alt="TOURZ" src="/assets/imgs/template/logo-footer.svg" /></Link>
                    ...
                    <div className="box-footer-col-3">
                        <div className="footer-col-1">
                            <div className="box-footer-help"><img alt="TOURZ" src="/assets/imgs/page/homepage6/help.svg" />
                        ...
                        <div className="footer-col-2">
                            <div className="box-join"><img alt="TOURZ" src="/assets/imgs/page/homepage6/join.svg" /><span className="text-xl-bold">Join TOURZ Affiliate Program Today !</span></div>
                        </div>
                        <div className="footer-col-3">
                            <div className="box-send-message"> <img alt="TOURZ" src="/assets/imgs/page/homepage6/msg.svg" />
