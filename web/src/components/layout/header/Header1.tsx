				...
				{/* <div className="top-bar">
					<div className="container-fluid">
						<div className="text-header">
							<div className="text-unlock text-sm-bold">Unlock the Magic of Travel with T7wisa - Your Gateway to
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										<li className="mega-li"><Link className="active" href="/">Home</Link>
													...
													<div className="row align-items-center">
														<div className="col-lg-10">
															<div className="row align-items-center">
																...
																<div className="col-lg-4">
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/"> <img src="/assets/imgs/template/icons/activity.svg" alt="T7wisa" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-2"> <img src="/assets/imgs/template/icons/map.svg" alt="T7wisa" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-3"> <img src="/assets/imgs/template/icons/deck-chair.svg" alt="T7wisa" /></Link>
														...
														<div className="col-lg-2"><img src="/assets/imgs/template/world.png" alt="T7wisa" /></div>
													</div>
												</div>
											</div> */}
										</li>
										<li className="mega-li-small"><Link href="/tours">Tours</Link>
											{/* <div className="mega-menu">
										...
										<li className="mega-li-small"><Link href="/destinations">Destinations</Link>
												{/* <div className="mega-menu">
										...
										<li className=""><Link href="/hotels">Hotels</Link>
											{/* <ul className="sub-menu">
