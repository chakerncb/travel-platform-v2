					...
					<section className="box-section box-breadcrumb background-body">
						<div className="container">
							<ul className="breadcrumbs">
								...
								<li> <span className="text-breadcrumb">{tour.title}</span></li>
							</ul>
						</div>
					</section>
							...
							<div className="tour-header">
								...
								<div className="tour-metas">
									<div className="tour-meta-left">
										...
										<Link className="text-md-medium neutral-1000" href="#">TOUR-{tour.id}</Link>
									</div>
							...
							<div className="row mt-30">
								<div className="col-lg-8">
									<div className="box-info-tour">
										<div className="tour-info-group">
											...
											<div className="info-item">
												...
												<p className="text-lg-bold neutral-1000">
													{tour.duration_days ? `${tour.duration_days} days` : 'Flexible'}
												</p>
											</div>
										</div>
										<div className="tour-info-group">
										...
										<div className="tour-info-group">
											...
											<div className="info-item">
												...
												<p className="text-lg-bold neutral-1000">{tour.difficulty_level || 'All Levels'}</p>
											</div>
										</div>
										<div className="tour-info-group">
											...
											<div className="info-item">
												<p className="text-sm-medium neutral-600">Price</p>
												<p className="text-lg-bold neutral-1000">${tour.price}</p>
											</div>
										</div>
									</div>
									<div className="box-collapse-expand">
										...
										<div className="group-collapse-expand">
											<button className={isAccordion == 2 ? "btn btn-collapse collapsed" : "btn btn-collapse"} type="button" data-bs-toggle="collapse" data-bs-target="#collapseDestinations" aria-expanded="false" aria-controls="collapseDestinations" onClick={() => handleAccordion(2)}>
												<h6>Destinations</h6>
												<svg width={12} height={7} viewBox="0 0 12 7" xmlns="http://www.w3.org/2000/svg">
													<path d="M1 1L6 6L11 1" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg>
								...
								<div className="col-lg-4">
									...
									<div className="sidebar-banner"> 
										<Link href="#"><img src="/assets/imgs/page/tour-detail/banner-ads.png" alt="TOURZ" /></Link>
									</div>
								</div>
							</div>
						</div>
							...
							<div className="row align-items-end">
								...
								<div className="col-md-6 mb-30 wow fadeInRight">
									<div className="d-flex justify-content-center justify-content-md-end">
										<Link className="btn btn-black-lg" href="#">View More
