'use client'
import ByAirline from '@/src/components/Filter/ByAirline'
import ByClass from '@/src/components/Filter/ByClass'
...
import SortTicketsFilter from '@/src/components/elements/SortTicketsFilter'
import TicketCard1 from '@/src/components/elements/ticketcard/TicketCard1'
import Layout from "@/src/components/layout/Layout"
import SwiperGroupPayment10Slider from '@/src/components/slider/SwiperGroupPayment10Slider'
import rawticketsData from "@/src/util/tickets.json"
import useTicketFilter from '@/src/util/useTicketFilter'
						...
						<div className="container">
							<div className="box-content-main">
								...
								<div className="content-left order-lg-first">
									...
									<div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/tickets/banner-ads.png" alt="TOURZ" /></Link></div>
								</div>
							</div>
						</div>
					</section>
