                        ...
                        <div className="container">
                            ...
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p className="neutral-1000">Welcome to TOURZ! Before you begin using our platform, please take a  moment to review the terms and conditions that govern your use of our  website and services.</p>
