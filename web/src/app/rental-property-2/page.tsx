								...
								<div className="row">
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination2.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination3.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination4.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination5.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination6.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination7.png" alt="TOURZ" /></div>
									...
									<div className="col-xl-3 col-lg-4 col-sm-6">
										<div className="card-popular card-top-destination background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/homepage6/destination8.png" alt="TOURZ" /></div>
